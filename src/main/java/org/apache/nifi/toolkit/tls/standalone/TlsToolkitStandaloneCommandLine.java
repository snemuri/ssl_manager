...
public class TlsToolkitStandaloneCommandLine extends BaseTlsToolkitCommandLine {
    ...
    public static final String NIFI_DN_PREFIX_ARG = "dnPrefix";
    public static final String NIFI_DN_SUFFIX_ARG = "dnSuffix";
    ...
    public static final String DEFAULT_CA_NAME = "HDPCA";
    ...
    public static final String DESCRIPTION = "Creates certificates and config files for HDP cluster.";
    ...
    protected TlsToolkitStandaloneCommandLine(PasswordUtil passwordUtil) {
        ...
        addOptionWithArg("ca", CA_NAME, "Enter CA name.", DEFAULT_CA_NAME);
    ...
    protected CommandLine doParse(String... args) throws CommandLineParseException {
        ...
        caName = commandLine.getOptionValue(CA_NAME, DEFAULT_CA_NAME);
    ...
    public StandaloneConfig createConfig() {
        ...
        standaloneConfig.setCaName(caName);
        ...
        standaloneConfig.setKeyStore(caName + KEYSTORE + getKeyStoreType().toLowerCase());
